    ...
    for col in df.columns:
        if '相似列名' in result[col] or '匹配列名' in result[col]:
            ...
            try:
                ...
                print(f'{e} This should not happen!')
...
def main(input_path, output_path, mul_col):
    if mul_col != [0]:
        input_df = pd.read_excel(input_path, header=mul_col)
...
if __name__ == '__main__':
    ...
    main(input_path, output_path, mul_col=[0])
